...
class _CameraLiveState extends State<CameraLive>
{
  ...
  startCapturingPictures() async
  {
    ...
    String filePath = "$dirPath/{$timeNameforPicture}.png";
  ...
  Future<Map<String, dynamic>?> getResponse(File imageFile) async
  {
    ...
    final imgUploadRequest = http.MultipartRequest("POST", Uri.parse("http://max-image-caption-generator-test.2886795279-80-host01nc.environments.katacoda.com/model/predict"));
